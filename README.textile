...
## "Storage Space":#21-storage-space
## "AHRD's Memory Usage":#22-ahrd's-memory-usage
## "Runtime Examples":#23-runtime-examples
# "License":#3-license
# "Authors":#4-authors
...
@conda env create --name ahrd_snakemake@
