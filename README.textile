...
* Change your working directory to the workflow folder:
@cd AHRD_Snakemake@
...
To keep the benchmark consistent over time it needs to use the same releases of the data bases that are used.
We use Uniprot release 2021_02 is be specific.
Unfortunately old versions of uniref are only available in the XML format.
So we make use of the python script "unirefxml2fasta.py":https://gist.github.com/keuv-grvl/a5846eb2b6a122823185ccfb55aac12e created by "keuv.grvl":https://gist.github.com/keuv-grvl and "nick-youngblut":https://gist.github.com/nick-youngblut in order to recreate a fasta formatted version of uniref50.
