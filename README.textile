...
h3. 1.2 Run the BUSCO
* Run a BUSCO analysis of each fasta file in species.tsv
@bash -c "source ~/.bashrc; conda activate ahrd_snakemake; snakemake --use-conda --jobs 16 --until busco_all --profile NAME_OF_YOUR_CLUSTER_CONFIGURATION_PROFILE;" &> log.txt &@
