...
## "Run the workflow unsing conda for runtime installation of dependencies":#11-run-the-workflow-unsing-conda-for-runtime-installation-of-dependencies
## "Use Singularity to run the workflow in a Docker container":#12-use-singularity-to-run-the-workflow-in-a-docker-container
