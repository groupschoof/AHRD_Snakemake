...
rule download_uniref90:
    ...
    shell: "aria2c https://ftp.uniprot.org/pub/databases/uniprot/current_release/uniref/uniref90/RELEASE.metalink --follow-metalink=mem --select-file=2 --file-allocation=none --dir=resources &>{log}"
