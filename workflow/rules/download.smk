rule download_swissprot:
    ...
    shell: "aria2c https://ftp.uniprot.org/pub/databases/uniprot/current_release/knowledgebase/complete/RELEASE.metalink --follow-metalink=mem --select-file=6 --file-allocation=none --dir=../resources --log={log}"
...
rule download_uniref90:
    ...
    shell: "aria2c https://ftp.uniprot.org/pub/databases/uniprot/current_release/uniref/uniref90/RELEASE.metalink --follow-metalink=mem --select-file=5 --file-allocation=none --dir=../resources --log={log}"
...
#    shell: "wget -nv -P ../resources/ http://current.geneontology.org/annotations/goa_uniprot_all.gaf.gz -o {log}"
    shell: "aria2c https://ftp.ebi.ac.uk/pub/databases/GO/goa/UNIPROT/goa_uniprot_all.gaf.gz http://current.geneontology.org/annotations/goa_uniprot_all.gaf.gz --file-allocation=none --dir=../resources --log={log}"
