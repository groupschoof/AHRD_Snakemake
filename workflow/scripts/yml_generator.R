...
cat(paste("  token_score_bit_score_weight:", snakemake@params[["description_settings_token_score_bit_score_weight"]]), file=outFile, append=T, sep="\n")
cat(paste("  token_score_database_score_weight:", snakemake@params[["description_settings_token_score_database_score_weight"]]), file=outFile, append=T, sep="\n")
cat(paste("  token_score_overlap_score_weight:", snakemake@params[["description_settings_token_score_overlap_score_weight"]]), file=outFile, append=T, sep="\n")
cat("  blast_dbs:", file=outFile, append=T, sep="\n")
cat("    swissprot:", file=outFile, append=T, sep="\n")
cat(paste("      weight:", snakemake@params[["description_settings_blast_dbs_swissprot_weight"]]), file=outFile, append=T, sep="\n")
cat(paste("      annotation_score_bit_score_weight:", snakemake@params[["description_settings_blast_dbs_swissprot_annotation_score_bit_score_weight"]]), file=outFile, append=T, sep="\n")
cat("    uniref:", file=outFile, append=T, sep="\n")
cat(paste("      weight:", snakemake@params[["description_settings_blast_dbs_uniref_weight"]]), file=outFile, append=T, sep="\n")
cat(paste("      annotation_score_bit_score_weight:", snakemake@params[["description_settings_blast_dbs_uniref_annotation_score_bit_score_weight"]]), file=outFile, append=T, sep="\n")
cat("", file=outFile, append=T, sep="\n")
cat("go_settings:", file=outFile, append=T, sep="\n")
cat(paste("  token_score_bit_score_weight:", snakemake@params[["go_settings_token_score_bit_score_weight"]]), file=outFile, append=T, sep="\n")
cat(paste("  token_score_database_score_weight:", snakemake@params[["go_settings_token_score_database_score_weight"]]), file=outFile, append=T, sep="\n")
cat(paste("  token_score_overlap_score_weight:", snakemake@params[["go_settings_token_score_overlap_score_weight"]]), file=outFile, append=T, sep="\n")
cat(paste("  informative_token_threshold:", snakemake@params[["go_settings_informative_token_threshold"]]), file=outFile, append=T, sep="\n")
cat(paste("  go_term_score_evidence_code_weight:", snakemake@params[["go_settings_go_term_score_evidence_code_weight"]]), file=outFile, append=T, sep="\n")
cat("  blast_dbs:", file=outFile, append=T, sep="\n")
cat("    swissprot:", file=outFile, append=T, sep="\n")
cat(paste("      weight:", snakemake@params[["go_settings_blast_dbs_swissprot_weight"]]), file=outFile, append=T, sep="\n")
cat(paste("      annotation_score_bit_score_weight:", snakemake@params[["go_settings_blast_dbs_swissprot_annotation_score_bit_score_weight"]]), file=outFile, append=T, sep="\n")
cat(paste("      gene_ontology_reference: ", goa, sep=""), file=outFile, append=T, sep="\n")
cat("    uniref:", file=outFile, append=T, sep="\n")
cat(paste("      weight:", snakemake@params[["go_settings_blast_dbs_uniref_weight"]]), file=outFile, append=T, sep="\n")
cat(paste("      annotation_score_bit_score_weight:", snakemake@params[["go_settings_blast_dbs_uniref_annotation_score_bit_score_weight"]]), file=outFile, append=T, sep="\n")
