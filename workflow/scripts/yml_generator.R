...
cat(paste("  token_score_bit_score_weight:", snakemake@config[["ahrd"]][["description_settings"]][["token_score_bit_score_weight"]]), file=outFile, append=T, sep="\n")
cat(paste("  token_score_database_score_weight:", snakemake@config[["ahrd"]][["description_settings"]][["token_score_database_score_weight"]]), file=outFile, append=T, sep="\n")
cat(paste("  token_score_overlap_score_weight:", snakemake@config[["ahrd"]][["description_settings"]][["token_score_overlap_score_weight"]]), file=outFile, append=T, sep="\n")
cat("  blast_dbs:", file=outFile, append=T, sep="\n")
cat("    swissprot:", file=outFile, append=T, sep="\n")
cat(paste("      weight:", snakemake@config[["ahrd"]][["description_settings"]][["blast_dbs"]][["swissprot"]][["weight"]]), file=outFile, append=T, sep="\n")
cat(paste("      annotation_score_bit_score_weight:", snakemake@config[["ahrd"]][["description_settings"]][["blast_dbs"]][["swissprot"]][["annotation_score_bit_score_weight"]]), file=outFile, append=T, sep="\n")
cat("    uniref:", file=outFile, append=T, sep="\n")
cat(paste("      weight:", snakemake@config[["ahrd"]][["description_settings"]][["blast_dbs"]][["uniref"]][["weight"]]), file=outFile, append=T, sep="\n")
cat(paste("      annotation_score_bit_score_weight:", snakemake@config[["ahrd"]][["description_settings"]][["blast_dbs"]][["uniref"]][["annotation_score_bit_score_weight"]]), file=outFile, append=T, sep="\n")
cat("", file=outFile, append=T, sep="\n")
cat("go_settings:", file=outFile, append=T, sep="\n")
cat(paste("  token_score_bit_score_weight:", snakemake@config[["ahrd"]][["go_settings"]][["token_score_bit_score_weight"]]), file=outFile, append=T, sep="\n")
cat(paste("  token_score_database_score_weight:", snakemake@config[["ahrd"]][["go_settings"]][["token_score_database_score_weight"]]), file=outFile, append=T, sep="\n")
cat(paste("  token_score_overlap_score_weight:", snakemake@config[["ahrd"]][["go_settings"]][["token_score_overlap_score_weight"]]), file=outFile, append=T, sep="\n")
cat(paste("  informative_token_threshold:", snakemake@config[["ahrd"]][["go_settings"]][["informative_token_threshold"]]), file=outFile, append=T, sep="\n")
cat(paste("  go_term_score_evidence_code_weight:", snakemake@config[["ahrd"]][["go_settings"]][["go_term_score_evidence_code_weight"]]), file=outFile, append=T, sep="\n")
cat("  blast_dbs:", file=outFile, append=T, sep="\n")
cat("    swissprot:", file=outFile, append=T, sep="\n")
cat(paste("      weight:", snakemake@config[["ahrd"]][["go_settings"]][["blast_dbs"]][["swissprot"]][["weight"]]), file=outFile, append=T, sep="\n")
cat(paste("      annotation_score_bit_score_weight:", snakemake@config[["ahrd"]][["go_settings"]][["blast_dbs"]][["swissprot"]][["annotation_score_bit_score_weight"]]), file=outFile, append=T, sep="\n")
cat(paste("      gene_ontology_reference: ", goa, sep=""), file=outFile, append=T, sep="\n")
cat("    uniref:", file=outFile, append=T, sep="\n")
cat(paste("      weight:", snakemake@config[["ahrd"]][["go_settings"]][["blast_dbs"]][["uniref"]][["weight"]]), file=outFile, append=T, sep="\n")
cat(paste("      annotation_score_bit_score_weight:", snakemake@config[["ahrd"]][["go_settings"]][["blast_dbs"]][["uniref"]][["annotation_score_bit_score_weight"]]), file=outFile, append=T, sep="\n")
